        ...
        GeometryReader { geo in
            ZStack {
                Image("hogwarts")
                    ...
                    .padding(.top, 3)
                    .offset(
                        x: moveBackgroundImage ? geo.size.width / 1.1 :
                            -geo.size.width / 1.1
                    )
                    .onAppear {
                        // 60 seconds
                ...
                VStack {
                            ...
                            if animateViewsIn {
                                ...
                                .fullScreenCover(isPresented: $playGame) {
                                    Gameplay()
                                        ...
                                        .onAppear {
                                            // Fade out the volume of the title screen
                                            audioPlayer.setVolume(0, fadeDuration: 2)
                                        }
                                        .onDisappear {
                                            // Set the volume back when reappear
                    ...
                    // Or the Spacer() will push the buttons out of bounds due to the
...
#Preview {
    // In case if the preview has a bug for the animation
    VStack {
        ContentView()
            .environmentObject(Store())
            .environmentObject(Game())
